...
│   ├── silver_explenation.drawio       # Draw.io file for explain data flow in silver layer
│   ├── data_mart_logical_modeling.drawio              # Draw.io file for data models (star schema)
│
